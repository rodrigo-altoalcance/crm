...
export function EditAdminPermissionsForm({ companyId, userId, initialPermissions }: EditAdminPermissionsFormProps) {
  ...
  async function handleSave() {
    setLoading(true)
    try {
      const res = await fetch(`/api/admin/companies/${companyId}/team/${userId}`, {
        method: "PATCH",
      ...
      router.push(`/admin/companies/${companyId}/team`)
    } catch {
